        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Get Grocery delivered fast and easy for you </h1>
                    <h5 class="font-white space-xs">Select your favorite shop, order and get free delivery</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <button onclick="location.href='shop.php'" type="button" class="btn theme-btn btn-lg">Your Solid Grocery Shop</button>
                        </form>
                    </div>
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose your preferred Shop</h4> </div>
                        <!-- end:Step -->
