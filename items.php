...
<body>
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php" style="color:black">Grocerry Management System</a>
        ...
        <li class="nav-item"> <a class="nav-link active" href="#"><i class="fa fa-check"></i> Min Ghc 20.00</a> </li>
